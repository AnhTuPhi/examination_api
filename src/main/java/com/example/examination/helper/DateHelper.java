...
import com.example.examination.utils.ObjectUtils;
...
public class DateHelper {
    ...
    public static Long toLongFullDateFormat(Date date) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(DB_DATE_TIME);
        return Long.parseLong(simpleDateFormat.format(date.getTime()), 10);
    }

    public static String toFullDateFormat(LocalDateTime localDateTime) {
    ...
    public static String toDateFormatUI(LocalDate date) {
